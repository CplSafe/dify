...
const AppDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  useEffect(() => {
    ...
    // redirection
    if (pathname.endsWith('configuration') || pathname.endsWith('workflow')) {
  ...
  }, [appDetailRes, getNavigationConfig, isLoadingAppDetail, isLoadingCurrentWorkspace, pathname, router, appId])
