...
import { HELP_CENTER_ENABLED, HIDDEN_EXTERNAL_LINK } from '@/config'
...
export const defaultDocBaseUrl = HELP_CENTER_ENABLED ? 'https://docs.dify.ai' : ''
