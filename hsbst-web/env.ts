...
const clientSchema = {
  ...
  NEXT_PUBLIC_DEFAULT_SUPPORT_EMAIL: z.email().optional(),
...
export const env = createEnv({
  ...
  experimental__runtimeEnv: {
    ...
    NEXT_PUBLIC_DEFAULT_BRAND_NAME: isServer ? process.env.NEXT_PUBLIC_DEFAULT_BRAND_NAME : getRuntimeEnvFromBody('defaultBrandName'),
    NEXT_PUBLIC_DEFAULT_SUPPORT_EMAIL: isServer ? process.env.NEXT_PUBLIC_DEFAULT_SUPPORT_EMAIL : getRuntimeEnvFromBody('defaultSupportEmail'),
