...
export const useAppTownTrend = (appId: string, params?: DateRangeParams) => {
  return useAppStatisticsQuery<AppTownTrendResponse>('town-trend', appId, params)
}
