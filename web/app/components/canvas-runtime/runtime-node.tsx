...
// SSE node_type strings can arrive with either dashes or underscores
// depending on the engine version (e.g. "if-else" vs "if_else",
// "human-input" vs "human_input"). Register both spellings so the
// fallback fires regardless.
