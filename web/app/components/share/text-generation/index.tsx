...
const TextGeneration: FC<IMainProps> = ({
  ...
  const [runControl, setRunControl] = useState<TextGenerationRunControl | null>(
    null,
  )
  ...
  const [
    isShowResultPanel,
    { setTrue: showResultPanelState, setFalse: hideResultPanel },
  ] = useBoolean(false)
  ...
  const updateInputs = useCallback(
    (newInputs: Record<string, InputValueTypes>) => {
      setInputs(newInputs)
